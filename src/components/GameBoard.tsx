...
function GameBoard() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-5xl font-bold text-white text-center mb-2">Number Guesser</h1>
      <p className="text-xl text-blue-200 text-center mb-8">Guess the number between 1 and 100!</p>
